      ...
      <div className="min-h-screen bg-app-cream flex-center ">
        <div className="text-center">
          ...
          <button
            ...
            className="px-5 py-2.5 bg-app-green text-white rounded-2xl hover:bg-app-green-light hover:scale-105 transition-colors "
          >
            Browse Products
          </button>
        </div>
    ...
    <div className="min-h-screen bg-app-cream">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex items-center gap-2 mb-8">
          {steps.map((s, i) => (
            <div key={s.key} className="flex items-center gap-2 mb-8">
              <button
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-2xl p-5 h-fit sticky top-24">
            <h3 className="text-sm font-semibold text-app-text-light ">
              Order Summary
            </h3>
