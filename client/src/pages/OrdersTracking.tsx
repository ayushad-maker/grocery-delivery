...
const OrdersTracking = () => {
  ...
  if (!order) {
    <div className="flex items">Order Products First...</div>;
  }
    ...
    <div className="min-h-screen mb-20 bg-app-cream">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-2xl font-semibold text-app-text-light">
          ...
          <span
            className={`px-4 py-1.5 font-semibold rounded-full ${order!.status === "Delivered" ? "bg-green-200 text-green-700" : order!.status === "Cancelled" ? "bg-red-100 text-red-700" : "bg-app-orange/10 text-app-orange "}`}
          >
            {order!.status}
          </span>
        </div>
                ...
                <div className="bg-white rounded-2xl p-5 flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-app-text-light captialize">
