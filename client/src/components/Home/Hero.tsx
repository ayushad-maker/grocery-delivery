      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 w-full">
        <div className="max-w-xl xl:pl-10">
          ...
          <div className="flex flex-wrap gap-5">
            <Link
              to={"/products"}
              className="px-7 py-3 bg-orange-400 text-white font-semibold rounded-full hover:bg-orange-500 transtition-all flex items-center gap-2 active:scale-[0.98] w-xs"
            >
            ...
            <Link
              to={"/products"}
              className="px-7 py-3 bg-white/10 text-white font-semibold flex items-center gap-2 rounded-full hover:bg-white/20  transtition-all border-white/20 w-xs"
            >
